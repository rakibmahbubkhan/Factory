    ...
    <div class="row justify-content-center">
        <div class="col-12 col-lg-10 col-xl-8">
            ...
            <div class="d-flex flex-column flex-sm-row justify-content-between align-items-sm-center mb-4 gap-3">
                <div>
                    <h2 class="fw-bold mb-1" style="color: #2c3e50;">✨ Create New Product</h2>
                    <p class="text-muted small mb-0">Add a new product to your catalog</p>
                </div>
                ...
                <div class="card-body p-4 p-md-5">
                    ...
                    <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data" id="productForm">
                        ...
                        <div class="tab-content">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="product_name" class="form-control border-start-0 rounded-end-3 ps-0" 
                                               value="{{ old('product_name') }}" placeholder="e.g., Premium Wheat Seeds" required>
                                    </div>
                                </div>

                                <div class="mb-4">
                                    <label class="form-label fw-semibold">Description</label>
                                    <textarea id="myeditorinstance" name="description" class="form-control" placeholder="Enter detailed product description...">{{ old('description') }}</textarea>
                                </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="contact" class="form-control" 
                                                   value="{{ old('contact') }}" placeholder="+880 1XXX XXXXXX" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                            ...
                            <div class="tab-pane fade" id="details" role="tabpanel">
                                <div class="mb-4">
                                    ...
                                    <textarea name="key_features" class="form-control myeditorinstance" rows="4" 
                                              placeholder="Enter each feature on a new line or separate with commas&#10;e.g.,&#10;High yield variety,&#10;Drought resistant,&#10;Disease tolerant">{{ old('key_features') }}</textarea>
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea name="applications" class="form-control myeditorinstance" rows="4" 
                                              placeholder="Enter each application on a new line or separate with commas&#10;e.g.,&#10;Commercial farming,&#10;Home gardening,&#10;Greenhouse cultivation">{{ old('applications') }}</textarea>
                                    <div class="form-text text-muted mt-1">
                                        <i class="bi bi-info-circle"></i> Separate items with commas or line breaks
                                    </div>
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea name="benefits" class="form-control myeditorinstance" rows="4" 
                                              placeholder="Enter each benefit on a new line or separate with commas&#10;e.g.,&#10;Increased crop yield,&#10;Better soil health,&#10;Cost effective">{{ old('benefits') }}</textarea>
                                    <div class="form-text text-muted mt-1">
                                        <i class="bi bi-info-circle"></i> Separate items with commas or line breaks
                                    </div>
                                </div>
                                            ...
                                            <div class="card h-100 border-0 shadow-sm rounded-3 overflow-hidden">
                                                ...
                                                <div class="card-body p-3 text-center">
                                                    <label class="btn btn-outline-primary btn-sm w-100 rounded-pill">
                                                        ...
                                                        <input type="file" name="image{{ $i }}" class="d-none image-input" accept="image/*" data-preview="preview-{{ $i }}">
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="tab-pane fade" id="faq" role="tabpanel">
                                ...
                                <div id="faq-container" class="vstack gap-3">
                                    <div class="text-center text-muted py-4 bg-light rounded-3" id="emptyFaqState">
                        ...
                        <div class="d-flex flex-column flex-sm-row justify-content-end gap-2 mt-4 pt-3 border-top">
                            <button type="reset" class="btn btn-light rounded-pill px-4 order-2 order-sm-1" onclick="resetForm()">
...
<script>
    ...
    function addFaq() {
        ...
        const emptyState = document.getElementById('emptyFaqState');
        if (emptyState) {
            emptyState.remove();
        }
                ...
                reader.onload = function(ev) {
                    previewContainer.innerHTML = `
                        ...
                        <button type="button" class="btn btn-sm btn-danger position-absolute top-0 end-0 m-2 rounded-circle" 
                                style="width: 28px; height: 28px; padding: 0;" onclick="clearImagePreview(this)">
                            <i class="bi bi-x"></i>
                        </button>`;
                }
    ...
    function resetForm() {
        ...
        if (typeof tinymce !== 'undefined') {
            ...
            document.querySelectorAll('.myeditorinstance').forEach(editor => {
...
<script>
    ...
    // Initialize all description editors (for key_features, applications, benefits)
    tinymce.init({
        selector: '.myeditorinstance',
        height: 200,
        menubar: false,
